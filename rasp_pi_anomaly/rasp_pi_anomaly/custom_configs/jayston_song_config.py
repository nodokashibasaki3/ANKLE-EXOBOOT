...
config.VNMC_GAIN = 1.2
config.MUSCLE_UPDATE_FREQUENCY = 1
config.DO_INCLUDE_EXO_ADD_DATA = False
config.DO_INCLUDE_VNMC_DATA = True if config.STANCE_CONTROL_STYLE == config_util.StanceCtrlStyle.VIRTUALNEUROMUSCULARCONTROLLER else False
